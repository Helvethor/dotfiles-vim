...
emulators in the [glowtham-contrib][glowtham-contrib] repository.
...
``` viml
" vim-plug
Plug 'whatyouhide/vim-glowtham'
" NeoBundle
NeoBundle 'whatyouhide/vim-glowtham'
" Vundle
Plugin 'whatyouhide/vim-glowtham'
```
...
available. To use it, just replace `glowtham` with `glowtham256` in your `vimrc`:

``` viml
colorscheme glowtham256
```

Using `glowtham256` (given that your terminal supports 256 colors) ensures that
...
version and the 256 colors version:
    ...
    :AirlineTheme glowtham
    :AirlineTheme glowtham256
...
```viml
let g:glowtham_airline_emphasised_insert = 0
```
...
let g:lightline = { 'colorscheme': 'glowtham256' }
```
...
[glowtham-contrib][glowtham-contrib] repository.
...
[glowtham-contrib]: https://github.com/whatyouhide/glowtham-contrib
[vim-airline]: https://github.com/bling/vim-airline
[lightline.vim]: https://github.com/itchyny/lightline.vim
[emacs-version]: https://github.com/wasamasa/glowtham-theme
[contributors]: https://github.com/whatyouhide/vim-glowtham/graphs/contributors
