...
let g:airline#themes#glowtham#palette = {}
...
let g:airline#themes#glowtham#palette.normal =
      \ airline#themes#generate_color_map(s:N1, s:N2, s:N3)

" Overrides for when the buffer is modified in normal mode.
let g:airline#themes#glowtham#palette.normal_modified = {
...
let g:airline#themes#glowtham#palette.insert =
      \ airline#themes#generate_color_map(s:I1, s:I2, s:I3)

" Overrides for when the buffer is modified in insert mode.
let g:airline#themes#glowtham#palette.insert_modified = {
      \ 'airline_c': s:Array('magenta', 'base1', '')
      \ }

" Overrides for when the paste is toggled in insert mode.
let g:airline#themes#glowtham#palette.insert_paste = {
...
let g:airline#themes#glowtham#palette.visual =
      \ airline#themes#generate_color_map(s:V1, s:V2, s:V3)

" Overrides for when the buffer is modified.
let g:airline#themes#glowtham#palette.visual_modified =
      \ g:airline#themes#glowtham#palette.normal_modified
...
let g:airline#themes#glowtham#palette.inactive =
      \ airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

let g:airline#themes#glowtham#palette.inactive_modified = {
...
let g:airline#themes#glowtham#palette.accents = {
...
let g:airline#themes#glowtham#palette.ctrlp =
