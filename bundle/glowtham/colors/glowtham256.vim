...
" Base colors.
let s:colors.base0 = { 'gui': '#0a0f14', 'cterm': 232 }
let s:colors.base1 = { 'gui': '#0e1218', 'cterm': 233 }
let s:colors.base2 = { 'gui': '#091f2e', 'cterm': 17  }
let s:colors.base3 = { 'gui': '#0a3749', 'cterm': 18  }
let s:colors.base4 = { 'gui': '#245361', 'cterm': 31  }
...
let s:colors.red_hg     = { 'gui': '#d26937', 'cterm': 166 }
let s:colors.yellow     = { 'gui': '#edb443', 'cterm': 214 }
let s:colors.yellow_hg  = { 'gui': '#ffdb92', 'cterm': 214 }
let s:colors.magenta    = { 'gui': '#888ca6', 'cterm': 67  }
let s:colors.magenta_hg = { 'gui': '#a9a6bd', 'cterm': 60  }
let s:colors.blue       = { 'gui': '#195466', 'cterm': 24  }
let s:colors.blue_hg    = { 'gui': '#23768e', 'cterm': 24  }
let s:colors.cyan       = { 'gui': '#33859e', 'cterm': 44  }
let s:colors.cyan_hg    = { 'gui': '#64abbf', 'cterm': 44  }
let s:colors.green      = { 'gui': '#2aa889', 'cterm': 78  }
let s:colors.green_hg   = { 'gui': '#3ebf9f', 'cterm': 78  }
