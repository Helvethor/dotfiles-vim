...
"
" URL: https://github.com/whatyouhide/vim-glowtham
...
" Base colors.
let s:colors.base0 = { 'gui': '#ff0000', 'cterm': 0 }
let s:colors.base1 = { 'gui': '#ff0000', 'cterm': 8 }
let s:colors.base2 = { 'gui': '#ff0000', 'cterm': 10 }
let s:colors.base3 = { 'gui': '#ff0000', 'cterm': 12 }
let s:colors.base4 = { 'gui': '#ff0000', 'cterm': 11 }
let s:colors.base5 = { 'gui': '#ff0000', 'cterm': 14 }
let s:colors.base6 = { 'gui': '#ff0000', 'cterm': 7 }
let s:colors.base7 = { 'gui': '#ff0000', 'cterm': 15 }
